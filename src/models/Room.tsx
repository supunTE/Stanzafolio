...
import ModelMesh from "./ModelElement";
...
export function RoomModel(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        <ModelMesh name="Room" nodes={nodes.Room} hoverColor={"#7cfffc"} />
        <ModelMesh name="Tiles" nodes={nodes.Tiles} hoverColor={"#010112"} />
        <mesh
          name="Bulb_Wire"
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={nodes.Bed_Frame.material}
        ...
        <ModelMesh
          ...
          hoverColor={"#7aadff"}
          hoverContent={"Smart developers recharge with a day-time sleep. 🌞"}
        ...
        <mesh
          ...
          scale={[0.723, 1.079, 0.723]}
        />
        <mesh
          name="Bed_Pillow_Small"
          castShadow
          receiveShadow
          geometry={nodes.Bed_Pillow_Small.geometry}
          material={nodes.Bed_Pillow_Small.material}
        ...
        >
          ...
          >
            <mesh
              ...
              castShadow
              receiveShadow
              geometry={nodes.Btn_Holes.geometry}
              material={nodes.Btn_Holes.material}
